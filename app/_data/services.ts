...
export const services = [
  {
    ...
    href: "/services",
    imageSrc: "/placeholders/placeholder3.jpeg",
    icon: SiDatadog,
    body: [
      ...
      "Our dog training program is designed to help your canine companion become well-behaved, obedient, and a joy to be around. Polly, our professional dog trainer, utilizes effective training techniques and positive reinforcement to address behavioral issues, teach essential commands, and strengthen the bond between you and your dog.", "Whether you have a new puppy or an adult dog with specific training requirements, Polly will tailor the training sessions to your pet's individual needs, ensuring remarkable progress and a harmonious relationship. In addition to dog training, we understand that your pets need a loving and safe environment when you're away on holiday or have work commitments."," With our reliable holiday pet care services, we ensure that your pets receive the utmost attention, care, and companionship they deserve. From regular exercise and feeding to playtime and personalised attention, we will create a nurturing and secure environment, ensuring your pets feel at ease and loved throughout their stay.",
  ...
  },
  {
    ...
    imageSrc: "/services/training.jpeg",
    icon: GiJumpingDog,
    body: [
  ...
  },
  {
    ...
    imageSrc: "/services/walking.jpeg",
    icon: MdPets,
    body: [
  ...
  },
  {
    ...
    imageSrc: "/services/boarding.jpeg",
    icon: GiDogHouse,
    body: [
